...
- Includes WeaverCode attribution in commit message
...
This plugin is included in the WeaverCode repository. The commands are automatically available when using WeaverCode.
