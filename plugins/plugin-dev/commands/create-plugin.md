...
Guide the user through creating a complete, high-quality WeaverCode plugin from initial concept to tested implementation. Follow a systematic approach: understand requirements, design components, clarify details, implement following best practices, validate, and test.
...
**Goal**: Test that plugin works correctly in WeaverCode
