...
```
{
  ...
  "prompt": "You are analyzing a WeaverCode conversation to find behaviors the user wants to prevent.
...
Use the current working directory (where WeaverCode was started) as the base path.
