...
This reference covers features and patterns specific to commands bundled in WeaverCode plugins.
...
WeaverCode automatically discovers commands in plugins using the following locations:
