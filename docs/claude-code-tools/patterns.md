...
This reference provides common, proven patterns for implementing WeaverCode hooks. Use these patterns as starting points for typical hook use cases.
...
**Note:** Must restart WeaverCode after creating/removing flag files for hooks to recognize changes.
